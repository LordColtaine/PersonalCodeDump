	...
	int iCmdShow)
{
	...
	if (!gladLoadGL()) 
	{
		std::cout << "Could notinitialize GLAD\n";
	}
	else 
	{
		std::cout << "OpenGLVersion " <<GLVersion.major << "."<< GLVersion.minor <<"\n";
	}
	...
	{ //!swapControlSupported
			std::cout <<"WGL_EXT_swap_control notsupported\n";
	}
